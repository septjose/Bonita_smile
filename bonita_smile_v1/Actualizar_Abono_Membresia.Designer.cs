...
{
    partial class Actualizar_Abono_Membresia
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.txtAbono.Text = abono.montito.ToString();
            // 
            // txtComentario
            // 
            ...
            this.txtComentario.Text = abono.comentario;
            // 
            // btnAceptar
            // 
            ...
            this.Name = "Actualizar Abono Membresia";
            this.Text = "Actualizar Abono Membresia";
            ...
            if (!txtAbono.Text.Equals("") && !txt_efectivo.Text.Equals(""))
            {
                if (new Seguridad().validar_numero(txtAbono.Text) && new Seguridad().validar_numero(txt_efectivo.Text))
                {
                    ...
                    if (efectivo >= abono && abono > 0)
                    {
                        ...
                        restante = restante + this.total;

                        if (abono <= restante && restante > 0.0)
                        {
                            Abonos_Membresia ab = new Abonos_Membresia(bandera_online_offline);
                            bool actualizar = ab.ActualizarAbonoMembresia(this.abono.id_abono_membresia,  fecha_actual, abono.ToString(culture), comentario,id_membresia,paciente.id_paciente,paciente.clinica.id_clinica, alias);
                            if (actualizar)
                            {
